  ...
  return (
    <div className="about-container">
      ...
      <div className="about-container-second">
        <p>
          <h1>History</h1> <br /> First ever MasalFood restaurant was opened in
      ...
      <div className="about-container-first">
        <p>
          <h1>Restaurants</h1> <br /> Including all the restaurants, MasalFood
      ...
      <div className="about-container-second">
        <p>
          <h1>Future plans</h1> <br /> Main purpose of the MasalFood is opening
          the way of reaching the global market in following years. At the
